...
public class RegisterBeanScanner {
    ...
    private final Class<? extends IEventListener> handlerClass;
    private final List<String> scannerPackageNames;

    public RegisterBeanScanner(AnnotationMetadata importingClassMetadata, Class<? extends IEventListener> handlerClass) throws ClassNotFoundException {
