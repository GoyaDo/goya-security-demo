 ...
 */
@Getter
public class IEventAsyncSpringEvent extends IEventSpringEvent {

    private static final long serialVersionUID = -4866131480276824996L;

    public IEventAsyncSpringEvent(Object source, IEvent iEvent, EventRoutingDecision routingDecision) {
