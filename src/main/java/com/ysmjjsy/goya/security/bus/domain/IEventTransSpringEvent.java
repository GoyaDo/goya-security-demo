 ...
 */
@Getter
public class IEventTransSpringEvent extends IEventSpringEvent {

    private static final long serialVersionUID = -4866131480276824996L;

    public IEventTransSpringEvent(Object source, IEvent iEvent, EventRoutingDecision routingDecision) {
