 ...
 */
@Getter
public class IEventTransBeforeSpringEvent extends IEventSpringEvent {

    private static final long serialVersionUID = -4866131480276824996L;

    public IEventTransBeforeSpringEvent(Object source, IEvent iEvent, EventRoutingDecision routingDecision) {
