...
public interface MessageStore {
     ...
     */
    void updateStatus(String messageId, MessageStatus status, String errorMessage);
     ...
     */
    MessageRecord findById(String messageId);
     ...
     * @return 待发送的消息列表
     */
    List<MessageRecord> findReadyToSend(int limit);
     ...
     * @return 需要重试的消息列表
     */
    List<MessageRecord> findRetryable(int limit);
     ...
     * @return 状态统计映射
     */
    java.util.Map<MessageStatus, Long> countByStatus();
} 