 ...
 */
@Getter
public class IEventTransRollbackSpringEvent extends IEventSpringEvent {

    private static final long serialVersionUID = -4866131480276824996L;

    public IEventTransRollbackSpringEvent(Object source, IEvent iEvent, EventRoutingDecision routingDecision) {
