 ...
 */
@Getter
public class IEventTransCompletionSpringEvent extends IEventSpringEvent {

    private static final long serialVersionUID = -4866131480276824996L;

    public IEventTransCompletionSpringEvent(Object source, IEvent iEvent, EventRoutingDecision routingDecision) {
